...
public class AutomatonPackageImpl extends EPackageImpl implements AutomatonPackage {
	 ...
	 * @see org.lpdql.automaton.AutomatonPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static AutomatonPackage init() {
		...
		Object registeredAutomatonPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		AutomatonPackageImpl theAutomatonPackage = registeredAutomatonPackage instanceof AutomatonPackageImpl
				? (AutomatonPackageImpl) registeredAutomatonPackage
				: new AutomatonPackageImpl();
	 ...
	 */
	@Override
	public EReference getAutomaton_Inputs() {
	 ...
	 */
	@Override
	public EReference getAutomaton_Outputs() {
	...
	public void createPackageContents() {
		...
		createEReference(automatonEClass, AUTOMATON__INPUTS);
		createEReference(automatonEClass, AUTOMATON__OUTPUTS);
	...
	public void initializePackageContents() {
		...
		automatonEClass.getESuperTypes().add(this.getNamedElement());
		...
		initEReference(getTransition_Origin(), this.getState(), null, "origin", null, 0, 1, Transition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransition_Destination(), this.getState(), null, "destination", null, 0, 1, Transition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAutomaton_Inputs(), this.getInput(), null, "inputs", null, 0, -1, Automaton.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAutomaton_Outputs(), this.getOutput(), null, "outputs", null, 0, -1, Automaton.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
